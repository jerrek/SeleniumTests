...
//        driver.findElement(By.id("guestUser.fieldValues.ui_first_name")).sendKeys("");
//        driver.findElement(By.id("guestUser.fieldValues.ui_last_name")).sendKeys("");
//        driver.findElement(By.id("guestUser.fieldValues.ui_phone_number")).sendKeys("");
